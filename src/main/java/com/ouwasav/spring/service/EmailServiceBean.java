...
import com.ouwasav.spring.util.AsyncResponse;
...
public class EmailServiceBean implements EmailService {
    ...
    public Boolean send(Utilisateur utilisateur) {
        logger.info("> send");
    ...
    @Async
//    @Override
    public void sendAsync(Utilisateur utilisateur) {
    ...
    @Async
//    @Override
    public Future<Boolean> sendAsyncWithResult(Utilisateur utilisateur) {
        logger.info("> sendAsyncWithResult");

        AsyncResponse<Boolean> response = new AsyncResponse<Boolean>();

        try {
            Boolean success = send(utilisateur);
